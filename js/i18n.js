...
const EN = {
  ...
  '🔑 ลืมรหัสผ่าน ติดต่อแอดมิน': '🔑 Forgot your password? Contact an admin',  '← กลับไปเข้าสู่ระบบ': '← Back to sign in',
  'ชื่อผู้ใช้': 'Username',
  'รหัสผ่าน': 'Password',
  ...
  'ทดสอบสแกน': 'Scan test',
  'พบในระบบ': 'In system',
  'ไม่พบในระบบ': 'Not in system',
  'พบ': 'Found',
  'ไม่พบ': 'Not found',
  'ใช้เวลา': 'Took',
  'วินาที': 's',
  'กล้อง': 'camera',
  'ตัวอ่านของเบราว์เซอร์': 'browser reader',
  'ตัวอ่านแบบไลบรารี (ช้ากว่า)': 'library reader (slower)',
  'ยังไม่มีผล — กดเปิดกล้อง หรือยิงบาร์โค้ดลงช่องด้านบน': 'No results yet — open the camera, or scan into the box above',
  'ทดสอบสแกน — ไม่บันทึกอะไรลงระบบ': 'Scan test — nothing is saved',
  'กำลังเปิดกล้อง...': 'Opening camera...',
  'เล็งบาร์โค้ดให้อยู่ในกรอบ — ยิงต่อเนื่องได้เลย': 'Aim the barcode inside the frame — keep scanning',
  'สำเร็จ': 'Done',
  'เพิ่มแล้ว': 'Added',
  'ซ้ำกับที่สแกนไว้แล้ว': 'Already scanned',
  'ได้ SN': 'Got SN',
  'รับเข้า — สแกน SN': 'Receive — scan SN',
  'รับเข้าหลายชิ้น — สแกน SN ต่อเนื่อง': 'Receive many — keep scanning',
  'โอน / ขาย — สแกน SN': 'Transfer / sell — scan SN',
  'โอน / ขายหลายชิ้น — สแกน SN ต่อเนื่อง': 'Transfer / sell many — keep scanning',
  'สร้าง DO จากรายการ SN': 'Create a DO from SNs',
  'เพิ่ม SN เข้าใบ DO': 'Add SNs to the DO',
  'รับซ่อม — สแกน SN': 'Repair intake — scan SN',
  'สแกน SN เครื่องใหม่': 'Scan the replacement SN',
  '↩ ยกเลิกขาย': '↩ Sale cancelled',
  '➖ ออกทั้งหมด (เบิก + ขาย)': '➖ All out (withdrawn + sold)',
  '🚚 ขายให้ลูกค้า': '🚚 Sold to customer',
  'ตัดขายให้ลูกค้า — เข้าคิวรอออกใบ DO': 'Sell to a customer — queued to invoice on a DO',
  '— เลือกลูกค้า —': '— Select customer —',
  'ยังไม่มีอะไหล่ที่ตัดขายรอออกใบ': 'No sold parts waiting on a DO yet',
  'ต้องรัน sql/add-do-items-qty.sql ใน Supabase ก่อน จึงจะขายอะไหล่และออกใบ DO ได้': 'Run sql/add-do-items-qty.sql in Supabase first to sell parts on a DO',
  'ยกเลิกการขาย — คืนยอดเข้าอะไหล่': 'Cancel this sale — return the quantity to parts',
  'ไม่มี SN': 'No SN',
  'แก้ไข': 'Edit',
  'ลบ': 'Delete',
